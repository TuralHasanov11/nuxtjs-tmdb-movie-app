        ...
        <div v-if="show" class="container single-show">
            <div class="show-info">
                ...
                <div class="show-content">
                    ...
                    <!-- <h3 class="my-3">Seasons:</h3>  
                    <div v-for="(season,index) in show.seasons" :key="index" class="card mb-3 text-light bg-dark">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img style="width:100%; max-height: 25em;" :src="`https://image.tmdb.org/t/p/w500${season.poster_path!==null?season.poster_path:show.poster_path}`" class="img-fluid rounded-start">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
